        ...
        if request.method=='POST':
                ...
                if forms.is_valid():
                        ...
                        try:
                                # Replace 'XXXXXXXXXX' with the recipient's phone number
                                # The time is in 24-hour format
                                kit.sendwhatmsg(mobile_number, "Hi, Complaint has been Resolved ', 'Thanks for letting us know of your concern, Hope we have solved your issue. Dont Reply to this mail", scheduled_hours, scheduled_minutes)
                                print("Message scheduled!")
                        except Exception as e:
                                 print(f"An error occurred: {e}")
                        obj.save()
...
def pdf_viewer(request):
    ...
    print (delta.days )       
    if detailtype=='1':
            detailtype="Type of Complaint: tally1"
    if detailtype=='3':
            detailtype="Type of Complaint: tally2"
    if detailtype=='2':
            detailtype="Type of Complaint: tally3"
    if detailtype=='4':
            detailtype="Type of Complaint: tally4"
    if detailtype=='5':
            detailtype="Type of Complaint: tally5"
